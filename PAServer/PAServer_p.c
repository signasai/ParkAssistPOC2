...
typedef struct _PAServer_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } PAServer_MIDL_TYPE_FORMAT_STRING;

typedef struct _PAServer_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } PAServer_MIDL_PROC_FORMAT_STRING;

typedef struct _PAServer_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } PAServer_MIDL_EXPR_FORMAT_STRING;
...
extern const PAServer_MIDL_TYPE_FORMAT_STRING PAServer__MIDL_TypeFormatString;
extern const PAServer_MIDL_PROC_FORMAT_STRING PAServer__MIDL_ProcFormatString;
extern const PAServer_MIDL_EXPR_FORMAT_STRING PAServer__MIDL_ExprFormatString;
...
static const PAServer_MIDL_PROC_FORMAT_STRING PAServer__MIDL_ProcFormatString =
    {
        0,
        {
...
static const PAServer_MIDL_TYPE_FORMAT_STRING PAServer__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
static const MIDL_STUBLESS_PROXY_INFO IComponentRegistrar_ProxyInfo =
    {
    &Object_StubDesc,
    PAServer__MIDL_ProcFormatString.Format,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    PAServer__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _PAServer_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IComponentRegistrarProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _PAServer_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IComponentRegistrarStubVtbl,
    0
};

PCInterfaceName const _PAServer_InterfaceNamesList[] = 
{
    "IComponentRegistrar",
    0
};

const IID *  const _PAServer_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _PAServer_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _PAServer, pIID, n)

int __stdcall _PAServer_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_PAServer_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo PAServer_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _PAServer_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _PAServer_StubVtblList,
    (const PCInterfaceName * ) & _PAServer_InterfaceNamesList,
    (const IID ** ) & _PAServer_BaseIIDList,
    & _PAServer_IID_Lookup, 
    1,
    2,
